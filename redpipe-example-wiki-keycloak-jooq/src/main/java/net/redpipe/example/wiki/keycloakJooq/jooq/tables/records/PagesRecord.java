...
*/
package net.redpipe.example.wiki.keycloakJooq.jooq.tables.records;
...
public class PagesRecord extends UpdatableRecordImpl<PagesRecord> implements VertxPojo, Record3<Integer, String, String>, IPages {

    private static final long serialVersionUID = -1187501750;
    ...
    public PagesRecord(io.vertx.core.json.JsonObject json) {
        this();
        fromJson(json);
    }
}
